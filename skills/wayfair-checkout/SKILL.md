...
curl -X POST https://api.zinc.com/orders \
  ...
  -d '{
    "products": [{ "url": "https://www.wayfair.com/furniture/pdp-w100123456.html", "quantity": 1, "condition_in": ["New"] }],
    "max_price": 5000,
    "handling_days_max": 5,
    "shipping_address": {
      "first_name": "Jane",
...
Pass any wayfair.com product URL.

**Shipping:** check `GET /retailers` for Wayfair's current free-shipping terms, and include any shipping cost in `max_price`.
