...
curl -X POST https://api.zinc.com/orders \
  ...
  -d '{
    "products": [{ "url": "https://www.bestbuy.com/site/apple-airpods-pro-2nd-generation/4900964.p", "quantity": 1, "condition_in": ["New"] }],
    "max_price": 5000,
    "handling_days_max": 5,
    "shipping_address": {
      "first_name": "Jane",
...
Pass any bestbuy.com product URL.

**Shipping:** Best Buy ships free on orders over $35. For cheaper items, shipping is added to the order total, so leave room for it in `max_price`. (Live terms: `GET /retailers`.)
